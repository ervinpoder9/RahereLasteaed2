...
[TestClass] public class RoundingStrategyTests : BaseTests {
    ...
    [DataRow(3, 4, y, y)]
    [TestMethod]
    public void RoundTest(int decimals, int roundingDigit, double value, double expected) {
    ...
    [DataRow(3, y, y)]
    [TestMethod]
    public void RoundTowardsPositiveTest(int decimals, double value, double expected) {
